...
impactMetrics:
  - value: ">8x"
    ...
    description: The initial project's success led to a full UX audit.
  - value: 19 steps
    label: Refined end to end
    description: UX refinements shipped across app onboarding and corporate site.
  - value: "⁓45 seconds"
    label: Less to complete onboarding
