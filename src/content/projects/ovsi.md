...
client: Open Ventilator System Initiative
slug: ovsi
summary: Creating a visual identity and website for OVSI to help scale an open-source ventilator during the pandemic.
metaDescription: The Open Ventilator System Initiative (OVSI) needed a visual identity and website to attract manufacturers and explain a sophisticated, low-cost ventilator to both technical and non-technical audiences; I designed both to support their rapid response to COVID-19.
thumbnailImage: /content/writing/ovsi-1.png
order: 7
published: false
---
