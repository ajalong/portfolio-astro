---
title: GSK’s first company-wide design system on which all products are built.
client: GSK
slug: gsk
...
impactMetrics:
  - value: 5/5
    label: Product groups adopted
    description: Working group members drove adoption within teams.
  - value: 500+
    label: Primitive & semantic tokens
    description: Across colour and density modes with a deliberately lean component layer on top.
  - value: WCAG 2.1 AA
    label: Compliant
...
<SourceNote
  href="https://www.gsk.com/en-gb/company/gsk-at-a-glance/"
  text="GSK at a glance"
/>
...
For context on the 2022 rebrand, see [Wolff Olins’s case study](https://wolffolins.com/work/gsk).
