...
impactMetrics:
  - value: ">8x"
    ...
    description: Exploratory sprint grew into multiple product UX audits.
  - value: "~10%"
    label: Onboarding completion rate increase
    description: Tradu's product team's estimate based on findings of my onboarding audit.
  - value: "~45s"
...
<CardGroup columns={3} rows={2} flow="vertical">
  ...
  <MetricCard
    value="#1"
    label="UK Trading platform, Global Business & Finance Magazine"
  />
</CardGroup>
